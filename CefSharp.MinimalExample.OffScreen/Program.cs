...
namespace CefSharp.MinimalExample.OffScreen
{
    public class Program
    {
        ...
        {
            const string testUrl = "https://nitalk.com";// "http://player.youku.com/embed/XMTMwODg5OTcyMA";这个链接将下载视频到本地
        ...
        private static void Request_NotifyMsg(byte[] obj)
        {
            FileStream fs = new FileStream(++index + ".ts", FileMode.Create);
